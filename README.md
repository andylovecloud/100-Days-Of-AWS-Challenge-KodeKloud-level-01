...
## The rest of another labs can be found via the repository below

Thanks [MiqdadProjects](https://github.com/andylovecloud/KodeKloud-100-Days-Of-AWS) for making such a detail video tutorials.
